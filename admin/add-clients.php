    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="/admin/upload_image.php" class="nav-item nav-link ">Gallery</a>
                <a href="/admin/add-to-team.php" class="nav-item nav-link active">Team</a>
                    ...
                    <div class="position-relative h-100 shadow p-4">
                        ...
                        <form method="post" enctype="multipart/form-data" action="uploadimage.php">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="file" class="form-control" accept=".png,.jpg" name="client-image" required id="image" placeholder="">
